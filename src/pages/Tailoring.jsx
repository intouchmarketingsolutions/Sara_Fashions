...
import { FiScissors, FiClock, FiAward, FiArrowLeft, FiCheck } from 'react-icons/fi'
...
export default function Tailoring() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    const entry = { ...form, type: 'tailoring', date: new Date().toLocaleString('en-IN'), id: Date.now() }
    try {
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="grid sm:grid-cols-2 gap-4">
              ...
              <select required name="service" value={form.service} onChange={handleChange} className="border border-[#ddd] px-4 py-3 rounded-xl outline-none focus:border-[#c8a96b] text-[14px] text-[#555]">
